...
export const appPages: AppPage[] = [
  ...
  { id: 'bankDeposits', label: 'Bank Deposits', path: '/bank-deposit-records' },
  { id: 'drawerCount', label: 'Drawer Count', path: '/drawer-count' },
  ...
  { id: 'drawerSettings', label: 'Drawer Settings', path: '/drawer-settings', adminOnly: true },
  { id: 'cashAnalytics', label: 'Cash Analytics', path: '/cash-analytics', adminOnly: true },
  ...
  { id: 'quickCheckDatabase', label: 'Quick Check Database', path: '/quick-check-database', adminOnly: true },
