                ...
                <img
                  ...
                  onError={(e) => {
                    ...
                    if (target.dataset.retryCount) {
                      const retryCount = parseInt(target.dataset.retryCount);
                      if (retryCount >= 2) {
                    ...
                    if (imageUrl && !imageUrl.startsWith('http')) {
                      if (!imageUrl.startsWith('/uploads/')) {
                        ...
                        console.log(`Trying alternative URL pattern 1:`, newUrl);
                        target.src = getUploadUrl(newUrl);
                      } else if (!imageUrl.startsWith('/uploads/Inspections/')) {
                        const newUrl = imageUrl.replace('/uploads/', '/uploads/Inspections/');
                        console.log(`Trying alternative URL pattern 2:`, newUrl);
                        target.src = getUploadUrl(newUrl);
                      }
                    }
                  }}
                    ...
                    <CardContent>
                      ...
                      <List dense>
                        ...
                        <ListItem>
                          <ListItemText
                            primary="Status"
                            secondary={selectedRecord.status.replace('_', ' ')}
                          />
                        </ListItem>
                        <ListItem>
                          <ListItemText
          ...
          {slideshowImages.length > 0 && (
            <>
              ...
              <img
                ...
                onError={(e) => {
                  console.error('Failed to load slideshow image:', slideshowImages[currentImageIndex]?.url);
                  const target = e.currentTarget as HTMLImageElement;
