...
const StickerSettingsPage: React.FC = () => {
            ...
            <Grid container spacing={2} sx={{ mt: 1 }}>
              ...
              <Grid item xs={12} sm={6}>
                <TextField
                  ...
                  onChange={(e) => setOilTypeForm(prev => ({ ...prev, durationInDays: parseInt(e.target.value) || 0 }))}
              ...
              <Grid item xs={12} sm={6}>
                <TextField
                  ...
                  onChange={(e) => setOilTypeForm(prev => ({ ...prev, mileageInterval: parseInt(e.target.value) || 0 }))}
                  helperText="Miles until next oil change"
                />
              </Grid>
            </Grid>
          </DialogContent>
...
export default StickerSettingsPage; 